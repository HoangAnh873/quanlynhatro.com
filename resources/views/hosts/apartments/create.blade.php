    ...
    <div class="card-body">
        <form action="{{ route('host.apartments.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="location" name="location" class="form-control" placeholder="Nhập địa chỉ khu trọ" required onblur="getCoordinates()">
            </div>

            <div class="form-group">
                <label for="GPS_Latitude">Vĩ Độ</label>
                <input type="text" id="GPS_Latitude" name="GPS_Latitude" class="form-control" readonly>
            </div>

            <div class="form-group">
                <label for="GPS_Longitude">Kinh Độ</label>
